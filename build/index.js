...
var _webServerServerSideRenderer = require('./web/server/ServerSideRenderer');

var _webServerServerSideRenderer2 = _interopRequireDefault(_webServerServerSideRenderer);
...
siteRouter.get('/(.*)', function* (next) {
  var staticResources = require('./web/server/stats.json');
  var renderer = new _webServerServerSideRenderer2['default'](staticResources);
  var reactMarkup = yield renderer.renderPageAsync(this.url);
